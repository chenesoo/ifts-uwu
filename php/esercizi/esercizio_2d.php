...
/**
 * Conta gli studenti con chiave corso ugiale a $corso
 *
...
<body>
    ...
    // $s1[]="simpatico"; //ha indice 0
    // $s1[]="carino"; //ha indice 1

    $partecipanti_corsi = []; //n. partecipanti ad ogni corso

    foreach ($studenti as $studente) {
        //2) elencare tutti i cognomi
        echo elenco_dati_studente($studente) . "<br><br>";
        //echo $studente['cognome'] . "<br>";

        //se non conoscessi l'indice di s1, s2 o s3
        ...
        //scrivere uan funzione che conta gli studenti di un particolare corso
        echo "<br>studenti totali del corso $corso: " . count_studenti_corso($studenti, $corso);
        //3 e 4
