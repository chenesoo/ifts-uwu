        ...
        <form method="post" action="/hotels/create">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                    placeholder="Inserisci il nome dell'hotel" value="{{ old('name') }}" name="name">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                    placeholder="Inserisci l'indirizzo dell'hotel" value="{{ old('address') }}" name="address">
                    @error('address')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                </div>
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" value="yes" id="all_year" name="all_year"
                    @checked(old('all_year'))>
