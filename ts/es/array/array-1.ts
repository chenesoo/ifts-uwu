 ...
 *
 * 3. Creazione di un array di oggetti rappresentanti prodotti in un negozio online. Utilizzo
 *    del metodo filter() per restituire solo i prodotti con un prezzo inferiore a 50 euro.
 */
