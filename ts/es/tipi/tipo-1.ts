 ...
 *  persona.
 *  FACOLTATIVO
 *  - creare una funzione che stampa l'indirizzo senza le parentesi graffe
 *  - creare una proprietà facoltativa indirizzoLavoro stamparli senza fare copia-incolla 
 * del codice
 */

console.log("======[tipo-1.ts]======");
